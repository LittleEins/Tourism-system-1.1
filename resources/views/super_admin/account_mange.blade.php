              ...
              <thead>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="/account/edit?id={{ $list->id }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                    </td>
                    <td>
                      <a href="/supAdmin/account/delete?id={{ $list->id }}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                  @endforeach
              </tbody>
